...
@Slf4j
public class OldGitHelper {
    private final Path baseDir;

    @SneakyThrows
    public static OldGitHelper create(Path baseDir, GitModel config) {
        ...
        return new OldGitHelper(baseDir);
    }

    public OldGitHelper(Path baseDir) {
