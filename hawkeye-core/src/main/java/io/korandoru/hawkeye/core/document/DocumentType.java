...
public enum DocumentType {
    ACTIONSCRIPT("as", HeaderType.SLASHSTAR_STYLE, true, false),
    ...
    ASPECTJ("aj", HeaderType.SLASHSTAR_STYLE, true, false),
    ASSEMBLER("asm", HeaderType.SEMICOLON_STYLE, true, false),
    C("c", HeaderType.SLASHSTAR_STYLE, true, false),
    CC("cc", HeaderType.SLASHSTAR_STYLE, true, false),
    ...
    CPP("cpp", HeaderType.SLASHSTAR_STYLE, true, false),
    CSHARP("cs", HeaderType.SLASHSTAR_STYLE, true, false),
    CSS("css", HeaderType.SLASHSTAR_STYLE, true, false),
    ...
    GO_MOD("go.mod", HeaderType.SLASHSTAR_STYLE, false, true),
    ...
    KOTLIN_SCRIPT("kts", HeaderType.SLASHSTAR_STYLE, true, false),
    ...
    SCSS("scss", HeaderType.SLASHSTAR_STYLE, true, false),
