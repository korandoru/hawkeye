...
public class HawkEyeExtension {
    ...
    public List<HawkEyeConfig> getConfigs() {
        return configs;
    }
    ...
    public HawkEyeExtension(Project project) {
        ...
        project.afterEvaluate(ignore -> {
            checkTask.configure(task -> System.out.println("check:configs=" + configs));
            formatTask.configure(task -> System.out.println("format:configs=" + configs));
            removeTask.configure(task -> System.out.println("remove:configs=" + configs));
        });
    }
}
